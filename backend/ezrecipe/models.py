...
class EzrecipeEzrecipe(models.Model):
    ingredients = models.TextField()

    class Meta:
        managed = False
        db_table = 'ezrecipe_ezrecipe'
...
class Recipes(models.Model):
    ...
    recipe_name = models.TextField(blank=True, null=True)
    num_ingredients = models.IntegerField(blank=True, null=True)
...
class InputIngredients(models.Model):
    ...
    ingredients_str = ArrayField(models.TextField(blank=True, null=True))

    class Meta:
        managed = False
        db_table = 'input_ingredients'
